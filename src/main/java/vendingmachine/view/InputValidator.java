...
public class InputValidator {
    ...
    private static boolean invalidMoneyUnit(String money) {
        return Integer.parseInt(money) % MONEY_UNIT != 0;
    }

    public static void validateProducts(String[] products) {
    ...
    private static boolean invalidDetailForm(String[] productDetails) {
